...
class _RacePageState extends State<RacePage> {
  ...
  Column offerride({required double height,required TextEditingController controller1, 
  required TextEditingController controller2, required TextEditingController controller3}){
    final bar1=_buildsearchappbar(1, title: "De onde estamos saindo?",
         controller: controller1, icon: Icon(Icons.search), 
         iconcolor: Colors.white, fillColor: Colors.black87,
         subtitle: "Insira o endereço");
    final bar2=_buildsearchappbar(2, title: "Para onde estamos indo?", controller: controller2, 
         icon:const Icon(Icons.search), iconcolor: Colors.white, 
         fillColor: Colors.black87, subtitle: "Insira o endereço");
  ...
  Widget build(BuildContext context) {
    ...
    body: TabBarView(children: [
      Column(children: [
        ...
        _buildsearchappbar(0,title:"Para onde ?",subtitle:"Qualquer lugar Qualquer data 1 pessoa" ,controller:search,fillColor: Colors.black12,
        iconcolor: Colors.white,icon: Icon(Icons.search)),)),

  ],),Padding(padding: EdgeInsets.symmetric(horizontal: 16,vertical: 0),
  child:offerride(height: 20,controller1: controller1, controller2: controller2, 
